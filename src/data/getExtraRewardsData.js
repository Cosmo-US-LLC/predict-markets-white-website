...
export const membershipCards = [
  {
    ...
    stakingEnabled: true,
    bonusPredictPercent: 10,
    predictMarketsCredits: 0,
    usdtStakingRewards: false,
    founderVipAccess: false,
    benefits: [
      "Staking Enabled",
      "10% $PREDICT Bonus",
  ...
  },
  {
    ...
    stakingEnabled: true,
    bonusPredictPercent: 20,
    predictMarketsCredits: 1000,
    usdtStakingRewards: false,
    founderVipAccess: false,
    benefits: [
      "Staking Enabled",
  ...
  },
  {
    ...
    stakingEnabled: true,
    bonusPredictPercent: 30,
    predictMarketsCredits: 5000,
    usdtStakingRewards: true,
    founderVipAccess: false,
    benefits: [
      "Staking Enabled",
      "30% $PREDICT Bonus",
  ...
  },
  {
    ...
    stakingEnabled: true,
    bonusPredictPercent: 40,
    predictMarketsCredits: 10000,
    usdtStakingRewards: true,
    founderVipAccess: false,
    benefits: [
      "Staking Enabled",
  ...
  },
  {
    ...
    stakingEnabled: true,
    bonusPredictPercent: 50,
    predictMarketsCredits: 20000,
    usdtStakingRewards: true,
    founderVipAccess: false,
    benefits: [
      "Staking Enabled",
