...
export default function PresaleDashboard({
  ...
  const sortedMembershipCards = [...membershipCards].sort(
    (a, b) => a.minAmount - b.minAmount,
  );
  const matchingCardIndex = sortedMembershipCards.findIndex(
    (card) => card.id === matchingCard?.id,
  );
  const nextMatchingCard =
    matchingCardIndex >= 0
      ? sortedMembershipCards[matchingCardIndex + 1] || null
      : null;
  const nextLevelTarget = nextMatchingCard
    ? nextMatchingCard.minAmount
    : matchingCard?.minAmount || sliderMax;
  const remainingToNextLevel = nextMatchingCard
    ? Math.max(0, nextMatchingCard.minAmount - sliderValueState)
    : 0;
  ...
  return (
    <div
      className="relative w-full max-w-[100%] mx-auto bg-white rounded-[13.675px] border border-[#D8D8D8] shadow-xl py-[15px] 
    ...
    >
      ...
      <div className="flex items-center justify-center mb-4 absolute top-[-15px] left-1/2 transform -translate-x-1/2">
        <div className="bg-[#0080ED] text-white px-4 py-1.5 rounded-[4px] !text-[12px] font-[Inter] font-[600] uppercase flex items-center gap-2">
          ...
          <div
            className="w-2 h-2 bg-white rounded-full flex items-center justify-center flex-shrink-0"
      ...
      <div
        className="flex items-center justify-between mb-[15px] p-1 gap-2 border  border-gray-800 
      rounded-[100px] "
      >
        {tabs.map((tab, index) => {
          ...
          return (
            ...
            >
              {/* Icon */}
              <span
                className={`leading-none ${activeTab === tab.id ? "text-black" : "text-gray-700"}`}
              >
                <IconComponent />
              </span>
              {/* Label */}
      ...
      {/* Presale Progress */}
      <div
        className="mb-[8px] px-[16px] py-[8px] bg-[#F5F5F5] rounded-[8px]"
        style={{
          border: "1px solid rgba(0, 0, 0, 0.10)",
        }}
      >
        <h2
          className="heading-two md:!text-[32px] !leading-[100%] !text-center mb-2 !font-[500] 
        !font-[Helvetica Neue Medium Extended]"
        >
          {backend.totalRaisedUsd > 0
            ? backend.formattedTotalRaised
            : presaleAmount}
        </h2>
        ...
        <div className="relative w-full bg-gray-200 rounded-full h-[10px] mb-3">
          <div
            ...
            style={{
              width: `${backend.progressPercent ?? softcapPercentage}%`,
            }}
          >
        ...
        <div className="flex justify-between p-[5px] !pb-0 items-center text-[14px] !border-l-[0px] !border-r-[0px]  !border-b-[0px] mb-1 border-[1px] border-[#D4D4D4]">
          ...
          <h5 className="text-[10px] !font-[700] !font-[Inter] text-[#7B7B7B] text-center">
            {holdersCount} Holders
          </h5>
          <div className="border-l-[1px] h-[10px] border-[#D4D4D4]"></div>

          <h5 className="text-[10px] !font-[700] !font-[Inter] text-[#7B7B7B]">
            Goal: {softcapTarget}
          </h5>
        </div>
      </div>
      ...
      <div className="mb-[10px] ">
        ...
        <div className="grid grid-cols-3 gap-2">
          {paymentOptions.map((option, index) => {
            ...
            const hasDropdown =
              isLastItem && option.networks && option.networks.length > 1;
                ...
                <button
                  onClick={() => {
                    if (option.id === "more") {
                      ...
                      setOpenDropdownId(
                        openDropdownId === option.id ? null : option.id,
                      );
                    } else {
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-center">
                    ...
                    <div className="md:text-[12px] text-[10px]  text-gray-500  leading-[13px]">
                      {selectedPayment.includes(option.name)
                        ? selectedPayment.split(" ").slice(1).join(" ") ||
                          option.network
                        : option.network}
                    </div>
                  </div>
                  ...
                  >
                    {option.networks.map((network) => {
                      ...
                      const isCurrentlySelected =
                        selectedPayment === `${option.name} ${network}`;
                      return (
                        <button
                          key={network}
                          onClick={(e) => {
                          ...
                          className={`w-full flex items-center gap-2 px-3 py-1/2 text-left text-sm hover:bg-gray-50 transition-colors ${
                            isCurrentlySelected
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0 text-left">
                            ...
                            <div
                              className={`text-[10px] mt-0.5 text-left ${
                                isCurrentlySelected
                                  ? "text-[#0080ED]"
                                  : "text-gray-500"
                              }`}
      ...
      <div className="bg-[#F7F7F7] rounded-[4px] border-[1px] border-[#D4D4D4] px-4 py-[5px] mb-[15px]">
        <div className="flex justify-center space-x-2 items-center text-sm">
          <div className="flex items-center gap-2">
            <span className="text-black text-[12px] md:text-[12px] !font-[600]">
              Presale Price ={" "}
            </span>
            <span className="font-semibold text-[12px] md:text-[12px] font-bold text-[#0080ED]">
              {backend.presalePriceDisplay}
            </span>
          </div>
          ...
          <div className="flex  md:h-[46px] items-center gap-0 border border-gray-200 rounded-lg bg-gray-50 overflow-hidden">
            ...
            <div className="flex items-center gap-2 px-3 py-2 w-[30%] border-l border-gray-200 bg-transparent">
              ...
              <div className="flex flex-col">
                <span className="md:text-sm text-[12px] font-bold text-gray-800 leading-tight">
                  {selectedPaymentOption.name}
                </span>
                <span className="md:text-xs text-[10px] text-gray-600 leading-tight">
      ...
      <div className="text-center text-[12px] text-gray-600 bg-[#F2F2F2] p-[6px] rounded-[8px] border border-gray-100">
        ...
        <br /> with the code{" "}
        <span className="font-semibold text-[#000]">{bonusCode}</span> (valid
        for a limited time only).
      </div>
      <div className="flex items-center justify-center gap-4 text-xs text-gray-600 mt-[15px]">
        <Link
          to="/bonus-code"
          className="flex items-center gap-1 hover:text-[#0080ED] transition-colors"
        >
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="relative mt-10 w-full max-w-[700px] md:mt-0 md:max-w-[750px]">
            <div className="absolute top-[-40px] left-1/2 z-10 flex w-full -translate-x-1/2 items-center justify-center px-2 md:px-0">
              <div className="flex w-full items-center justify-center">
                <p
                  className="text-[#fff] bg-[#0080ED] !text-[16px] py-[8px] px-[12px]
            ...
            >
              ...
              <div className="p-6 space-y-4 ">
                ...
                <div className="flex items-center bg-[#fff] p-2 rounded-[8px] flex-col">
                  <p className="text-[14px] md:text-[16px] text-[#000] font-[600] mb-1 font-[Inter]">
                    Your Wallet Address:
                  </p>
                ...
                <div className="flex items-center bg-[#fff] p-2 rounded-[8px] flex-col">
                  ...
                  <h2
                    className="text-[32px] md:text-[40px] font-bold text-[#0080ED]
                 mb-1 font-[Inter]"
                  >
                    $1,400
                  </h2>
                  <div className="flex items-center gap-4 ">
                    <span className="text-[12px] md:text-[14px] text-gray-600 font-[Inter]">
                      Bought for $500
                    </span>
                    <span className="rounded-[4px] bg-[#D7F8DF] px-2 py-[2px] text-[12px] md:text-[14px] text-[#06B64B] font-semibold font-[Inter]">
                      +$900
                    </span>
                  </div>
                </div>
                ...
                <div className="flex justify-center rounded-[8px] bg-[#fff] p-2 pt-4">
                  <p className="text-[14px] md:text-[16px] font-[600] text-[#000] font-[Inter]">
                    $PREDICT Listing Price ={" "}
                    <span className="font-[600] text-[#000]">$0.03</span>
                  </p>
                </div>
                      ...
                      {[
                        {
                          ...
                          icon: (
                            ...
                            >
                              <path
                                d="M5.45703 0.428686C5.45703 0.191929 5.64896 0 5.88572 0H7.82228V1.75462C7.82228 1.99138 7.63036 2.18331 7.3936 2.18331H5.45703V0.428686Z"
                                fill="white"
                              />
                              <path
                                d="M2.72656 0.428686C2.72656 0.191929 2.91849 0 3.15525 0H5.09182V1.75462C5.09182 1.99138 4.89989 2.18331 4.66313 2.18331H2.72656V0.428686Z"
                                fill="white"
                              />
                              <path
                                d="M5.45703 2.97751C5.45703 2.74076 5.64896 2.54883 5.88572 2.54883H7.82228V4.30345C7.82228 4.54021 7.63036 4.73214 7.3936 4.73214H5.45703V2.97751Z"
                                fill="white"
                              />
                              <path
                                d="M2.72656 5.52439C2.72656 5.28763 2.91849 5.0957 3.15525 5.0957H5.09182V6.85033C5.09182 7.08708 4.89989 7.27901 4.66313 7.27901H2.72656V5.52439Z"
                                fill="white"
                              />
                              <path
                                d="M0 0.428686C0 0.191929 0.191929 0 0.428686 0H2.36525V1.75462C2.36525 1.99138 2.17332 2.18331 1.93657 2.18331H0V0.428686Z"
                                fill="white"
                              />
                              <path
                                d="M0 2.97751C0 2.74076 0.191929 2.54883 0.428686 2.54883H2.36525V4.30345C2.36525 4.54021 2.17332 4.73214 1.93657 4.73214H0V2.97751Z"
                                fill="white"
                              />
                              <path
                                d="M0 8.07126C0 7.83451 0.191929 7.64258 0.428686 7.64258H2.36525V9.3972C2.36525 9.63396 2.17332 9.82589 1.93657 9.82589H0V8.07126Z"
                                fill="white"
                              />
                              <path
                                d="M0 5.52439C0 5.28763 0.191929 5.0957 0.428686 5.0957H2.36525V6.85033C2.36525 7.08708 2.17332 7.27901 1.93657 7.27901H0V5.52439Z"
                                fill="white"
                              />
                            </svg>
                          ),
                          ...
                          icon: (
                            ...
                            >
                              <g clipPath="url(#clip0_bonus_predict)">
                                <path
                                  d="M12.674 0.916016V3.58268M11.3407 2.24935H14.0073M14.166 12.416V15.0827M12.8327 13.7493H15.4993M7.16667 0.916016C7.15 5.10335 9.186 7.47868 13.8333 7.58268C9.52333 7.56602 7.38533 9.87668 7.16667 14.2493C7.12467 10.1247 5.28133 7.57668 0.5 7.58268C4.77733 7.52268 7.15 5.45802 7.16667 0.916016Z"
                                  stroke="#0080ED"
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                                />
                        ...
                        },
                        {
                          ...
                          icon: (
                            ...
                            >
                              <path
                                d="M7.33333 9.66732C7.33333 10.5873 8.826 11.334 10.6667 11.334C12.5073 11.334 14 10.5873 14 9.66732M2 6.33398C2 7.25398 3.49267 8.00065 5.33333 8.00065C6.084 8.00065 6.77667 7.87665 7.33333 7.66732M2 8.66732C2 9.58732 3.49267 10.334 5.33333 10.334C6.084 10.334 6.776 10.21 7.33333 10.0007M10.6667 8.66732C8.826 8.66732 7.33333 7.92065 7.33333 7.00065C7.33333 6.08065 8.826 5.33398 10.6667 5.33398C12.5073 5.33398 14 6.08065 14 7.00065C14 7.92065 12.5073 8.66732 10.6667 8.66732Z"
                                stroke="#0080ED"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                              />
                              <path
                                d="M2 3.66602V10.9993C2 11.9193 3.49267 12.666 5.33333 12.666C6.084 12.666 6.776 12.542 7.33333 12.3327M7.33333 12.3327V6.99935M7.33333 12.3327C7.33333 13.2527 8.826 13.9993 10.6667 13.9993C12.5073 13.9993 14 13.2527 14 12.3327V6.99935M8.66667 5.66602V3.66602"
                                stroke="#0080ED"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                              />
                              <path
                                d="M5.33333 5.33333C3.49267 5.33333 2 4.58667 2 3.66667C2 2.74667 3.49267 2 5.33333 2C7.174 2 8.66667 2.74667 8.66667 3.66667C8.66667 4.58667 7.174 5.33333 5.33333 5.33333Z"
                                stroke="#0080ED"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                              />
                        ...
                        },
                        {
                          ...
                          icon: (
                            ...
                            >
                              <path
                                d="M7.99891 14V8M7.99891 4.66667H5.29891C3.45224 4.66667 3.33891 2 5.29891 2C7.39891 2 7.99891 4.66667 7.99891 4.66667ZM7.99891 4.66667H10.6989C12.6296 4.66667 12.6296 2 10.6989 2C8.59891 2 7.99891 4.66667 7.99891 4.66667Z"
                                stroke="#0080ED"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                              />
                        ...
                        <div
                          key={index}
                          className="flex items-center justify-evenly md:justify-between px-5 md:px-0 border-b border-gray-100 py-[10px] md:py-[13px] last:border-b-0"
                        >
                          <div className="flex w-[62%] md:w-auto items-center gap-2 text-left">
                            <div
                              className={`w-4 h-4 flex-shrink-0 flex items-center justify-center rounded ${index === 0 ? "bg-[#0080ED] p-1" : ""}`}
                            >
                              {item.icon}
                            </div>
                            <span className="text-[12px] text-[#000] font-[Inter]">
                              {item.label}
                            </span>
                          </div>
                  ...
                  <div className="order-2">
                    <div className="rounded-[8px] bg-white px-4 py-2 md:rounded-none md:bg-transparent md:px-0 md:py-0">
                      ...
                      <div className="relative md:rounded-[8px] md:bg-white md:px-4 md:py-2">
                        <p
                          className="text-[14px] md:text-[16px] font-bold text-center text-black
                     mb-3 font-[Inter]"
                        >
                          Your Membership NFT
                        </p>
                                      ...
                                      <div
                                        ...
                                        style={{
                                          background:
                                            ...
                                            card.nftBackgroundGradient ||
                                            "linear-gradient(to bottom right, #1a1a1a, #2d2d2d)",
                                        }}
                                      >
                                        <div className="flex items-start justify-between mb-3">
                                          <div>
                                            <p className="text-[10px] text-gray-300 font-[Inter] mb-1">
                                              P PredictMarkets
                                            </p>
                                            <p className="text-[18px] md:text-[20px] font-bold text-white font-[Inter]">
                                              {card.tier} Member
                                            </p>
                                          </div>
                                          <div
                          ...
                          <div className="rounded-[5px] border border-[#CFCFCF] bg-white px-[7px] py-[6px]">
                            <div className="h-[8px] w-full rounded-full bg-[#ECECEC]">
                              <div
                                ...
                                style={{
                                  width: `${Math.max(sliderPercentage, 2)}%`,
                                }}
                              />
                            </div>
                          </div>
