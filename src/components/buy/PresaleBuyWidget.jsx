...
export function PresaleBuyWidget() {
  ...
  return (
    <div
      className={`flex flex-col gap-4 relative mx-auto w-full max-w-[30rem] rounded-[13.675px] border border-[#D8D8D8] bg-white px-[10px] py-[15px] shadow-xl md:px-[44px] md:py-[24px] min-h-[47rem] md:min-h-[49rem] justify-between`}
    >
